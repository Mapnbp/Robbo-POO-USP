...
public class GamePanel extends JPanel {
    ...
    public transient ControleFase cFase = new ControleFase(this);
    ...
    public void update() throws IOException{
        ...
        if(gameState == playState){
            if(keyH.salva){
                saveLoad.save(heroi, faseAtual, "savegame.dat");
                keyH.salva = false;
            }
            
            if(keyH.carrega) {
                Object[] dados = SaveLoad.load("savegame.dat");
                if (dados != null) {
                    Heroi heroiCarregado = (Heroi) dados[0];
                    Fase faseCarregada = (Fase) dados[1];
                    heroiCarregado.setControladores(this, keyH);
